...
> **必须具备 TPM 2.0**
>
> 解锁器现已要求 TPM 2.0。没有 TPM 2.0，无法使用解锁器。
>
> 查看 [启用 TPM 2.0](zh/enable-tpm.md)，检查电脑并找到对应主板品牌的设置方法。

开始前，请确保您的系统满足以下要求：

- **Windows 10 专业版（Pro，22H2）** 或 **Windows 11 专业版（Pro，24H2 或 25H2）**。家庭版（Home）及其他版本不受支持。
- 魔兽世界正式服 (EU/US/CN)
